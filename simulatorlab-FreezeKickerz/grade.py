...
def grade(submission_dir):
    ...
    return (part1_score, part1_total_possible)

if __name__ == "__main__":
    submission_dir = "."
    part1_score, part1_total_possible = grade(submission_dir)
    print(f"Total score: {part1_score}/{part1_total_possible}")
